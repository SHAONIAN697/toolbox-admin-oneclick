...
namespace ToolboxClient
{
    ...
    internal sealed class ToolboxForm : Form
    {
        ...
        private string PortalKnownLabel(string text)
        {
            ...
            string knownMapped = PortalKnownLabelMap(value);
            if (!String.IsNullOrWhiteSpace(knownMapped)) return knownMapped;
            ...
            if (value == "官方网站") return "Official Website";
            if (value == "官网") return "Official Website";
            if (value == "VC运行库") return "VC Runtime";
            if (value == "VC运行库合集") return "VC Runtime Pack";
            if (value == "微软运行库") return "Microsoft Runtime";
            if (value == "7zip解压缩" || value == "7-Zip解压缩" || value == "7zip压缩") return "7-Zip Extractor";
            if (value == "RAR解压缩" || value == "RAR压缩") return "RAR Extractor";
            if (value == "UU远程精简远控" || value == "UU远程" || value == "UU远控") return "UU Remote Control";
            if (value == "ToDesk远控" || value == "ToDesk远程") return "ToDesk Remote Control";
            if (value == "系统激活") return "System Activation";
            if (value == "一键激活系统") return "Windows Activation";
            if (value == "系统版本转换") return "Windows Edition Switch";
            if (value == "关闭系统更新") return "Disable Windows Update";
            if (value == "打开目录") return "Open Folder";
            if (value == "打开文件") return "Open File";
            return "";
        }

        private string PortalKnownLabelMap(string value)
        {
            if (value == "\u4e0b\u8f7d") return "Download";
            if (value == "\u547d\u4ee4") return "Command";
            if (value == "\u5b89\u88c5") return "Install";
            ...
            if (value == "\u670d\u52a1") return "Services";
            if (value == "\u673a\u67b6") return "Rack";
            if (value == "\u767e\u5ea6") return "Baidu";
            if (value == "\u7f51\u9875") return "Web Page";
            if (value == "\u811a\u672c") return "Script";
            if (value == "\u9996\u9875") return "Home";
            if (value == "\u5218\u89c8\u5668") return "Browser";
            if (value == "\u5de5\u5177\u7bb1") return "Toolbox";
            if (value == "\u6570\u636e\u5e93") return "Database";
            if (value == "\u672a\u547d\u540d") return "Untitled";
            if (value == "\u6ce8\u518c\u8868") return "Registry Editor";
            if (value == "\u6d4f\u89c8\u5668") return "Browser";
            if (value == "\u7ec4\u7b56\u7565") return "Group Policy";
            if (value == "\u8fd0\u884c\u5e93") return "Runtime";
            if (value == "UU\u8fdc\u63a7") return "UU Remote Control";
            if (value == "UU\u8fdc\u7a0b") return "UU Remote Control";
            if (value == "YY\u8bed\u97f3") return "YY Voice";
            if (value == "\u4e00\u952e\u9884\u8bbe") return "One-click Presets";
            if (value == "\u5168\u6c11K\u6b4c") return "WeSing";
            if (value == "\u58f0\u5361\u9a71\u52a8") return "Audio Drivers";
            if (value == "\u58f0\u97f3\u8bbe\u7f6e") return "Sound Settings";
            if (value == "\u5907\u4efd\u8fd8\u539f") return "Backup and Restore";
            if (value == "\u5b89\u5168\u5f00\u5173") return "Security Switches";
            if (value == "\u5b89\u5168\u6740\u6bd2") return "Security and Antivirus";
            if (value == "\u5b89\u5168\u7b56\u7565") return "Security Policy";
            if (value == "\u5b98\u65b9\u7f51\u7ad9") return "Official Website";
            if (value == "\u5e38\u7528\u5de5\u5177") return "Common Tools";
            if (value == "\u5e38\u7528\u7f51\u7ad9") return "Common Sites";
            if (value == "\u5e38\u7528\u8f6f\u4ef6") return "Common Software";
            if (value == "\u5fae\u4fe1\u652f\u4ed8") return "WeChat Pay";
            if (value == "\u6253\u5305\u8bbe\u7f6e") return "Package Settings";
            if (value == "\u6253\u5f00\u6587\u4ef6") return "Open File";
            if (value == "\u6253\u5f00\u76ee\u5f55") return "Open Folder";
            if (value == "\u6253\u5f00\u94fe\u63a5") return "Open Link";
            if (value == "\u63a7\u5236\u9762\u677f") return "Control Panel";
            if (value == "\u63d2\u4ef6\u4e2d\u5fc3") return "Plugin Center";
            if (value == "\u63d2\u4ef6\u68c0\u67e5") return "Plugin Check";
            if (value == "\u6682\u65e0\u5185\u5bb9") return "No Content";
            if (value == "\u673a\u67b6\u5bbf\u4e3b") return "Rack Host";
            if (value == "\u73af\u5883\u53d8\u91cf") return "Environment Variables";
            if (value == "\u7535\u6e90\u7761\u7720") return "Power and Sleep";
            if (value == "\u7535\u6e90\u7ba1\u7406") return "Power Management";
            if (value == "\u76f4\u64ad\u4f34\u4fa3") return "Live Companion";
            if (value == "\u78c1\u76d8\u7ba1\u7406") return "Disk Management";
            if (value == "\u7cfb\u7edf\u4f18\u5316") return "System Optimization";
            if (value == "\u7cfb\u7edf\u4fe1\u606f") return "System Information";
            if (value == "\u7cfb\u7edf\u5de5\u5177") return "System Tools";
            if (value == "\u7cfb\u7edf\u6e05\u7406") return "System Cleanup";
            if (value == "\u7cfb\u7edf\u6fc0\u6d3b") return "System Activation";
            if (value == "\u7f51\u7edc\u5de5\u5177") return "Network Tools";
            if (value == "\u7f51\u7edc\u8fde\u63a5") return "Network Connections";
            if (value == "\u8054\u7cfbQQ") return "Contact QQ";
            if (value == "\u8054\u7cfb\u5fae\u4fe1") return "Contact WeChat";
            if (value == "\u8054\u7cfb\u65b9\u5f0f") return "Contact";
            if (value == "\u865a\u62df\u4e50\u5668") return "Virtual Instruments";
            if (value == "\u89c6\u9891\u6559\u7a0b") return "Video Tutorials";
            if (value == "\u8c03\u8bd5\u5de5\u5177") return "Debug Tools";
            if (value == "\u8f6f\u4ef6\u5927\u5168") return "Software Catalog";
            if (value == "\u8fdc\u7a0b\u63a7\u5236") return "Remote Control";
            if (value == "\u8fdc\u7a0b\u684c\u9762") return "Remote Desktop";
            if (value == "\u9690\u79c1\u52a0\u56fa") return "Privacy Hardening";
            if (value == "\u9a71\u52a8\u786c\u4ef6") return "Drivers and Hardware";
            if (value == "\u9ed8\u8ba4\u5206\u7ec4") return "Default Group";
            if (value == "RAR\u538b\u7f29") return "RAR Extractor";
            if (value == "VC\u8fd0\u884c\u5e93") return "VC Runtime";
            if (value == "\u4e0b\u8f7d\u6700\u65b0\u7248") return "Download Latest Version";
            if (value == "\u4e3b\u6d41DAW") return "Mainstream DAWs";
            if (value == "\u4e8b\u4ef6\u67e5\u770b\u5668") return "Event Viewer";
            if (value == "\u4efb\u52a1\u7ba1\u7406\u5668") return "Task Manager";
            if (value == "\u514d\u8d39\u97f3\u8272\u5e93") return "Free Sound Libraries";
            if (value == "\u5173\u95ed\u9632\u706b\u5899") return "Turn Off Firewall";
            if (value == "\u547d\u4ee4\u63d0\u793a\u7b26") return "Command Prompt";
            if (value == "\u5de5\u5177\u7bb1\u66f4\u65b0") return "Toolbox Update";
            if (value == "\u5fae\u8f6f\u8fd0\u884c\u5e93") return "Microsoft Runtime";
            if (value == "\u7981\u7528UAC") return "Disable UAC";
            if (value == "\u7a0b\u5e8f\u548c\u529f\u80fd") return "Programs and Features";
            if (value == "\u8ba1\u7b97\u673a\u7ba1\u7406") return "Computer Management";
            if (value == "\u8bbe\u5907\u7ba1\u7406\u5668") return "Device Manager";
            if (value == "\u9632\u706b\u5899\u5f00\u5173") return "Firewall Switch";
            if (value == "64\u4f4d\u63d2\u4ef6\u5305") return "64-bit Plugin Pack";
            if (value == "7zip\u538b\u7f29") return "7-Zip Extractor";
            if (value == "RAR\u89e3\u538b\u7f29") return "RAR Extractor";
            if (value == "VST\u6548\u679c\u5668") return "VST Effects";
            if (value == "\u4e00\u952e\u6fc0\u6d3b\u7cfb\u7edf") return "Windows Activation";
            if (value == "\u514d\u8d39\u63d2\u4ef6\u63a8\u8350") return "Free Plugin Picks";
            if (value == "\u5173\u95ed\u7cfb\u7edf\u66f4\u65b0") return "Disable Windows Update";
            if (value == "\u5176\u4ed6\u5b9e\u7528\u5de5\u5177") return "Other Useful Tools";
            if (value == "\u5e38\u7528\u58f0\u5361\u9a71\u52a8") return "Common Audio Drivers";
            if (value == "\u65b0\u673a\u4e00\u952e\u4f18\u5316") return "New PC Optimization";
            if (value == "\u7981\u7528 UAC") return "Disable UAC";
            if (value == "\u7981\u7528\u7cfb\u7edf\u66f4\u65b0") return "Disable Windows Update";
            if (value == "\u7cfb\u7edf\u7248\u672c\u8f6c\u6362") return "Windows Edition Switch";
            if (value == "\u7eaf\u51c0\u6fc0\u6d3b\u5957\u88c5") return "Clean Activation Suite";
            if (value == "\u865a\u62df\u58f0\u5361\u9a71\u52a8") return "Virtual Audio Drivers";
            if (value == "\u97f3\u9891\u5de5\u7ad9\u4f18\u5316") return "Audio Workstation Optimization";
            if (value == "\u97f3\u9891\u7d20\u6750\u5e73\u53f0") return "Audio Asset Platforms";
            if (value == "\u97f3\u9891\u7f16\u8f91\u5de5\u5177") return "Audio Editing Tools";
            if (value == "\u97f3\u9891\u8d44\u6e90\u7f51\u7ad9") return "Audio Resource Sites";
            if (value == "\u9a71\u52a8\u7ba1\u7406\u5de5\u5177") return "Driver Managers";
            if (value == "7zip\u89e3\u538b\u7f29") return "7-Zip Extractor";
            if (value == "Hosts\u7ba1\u7406") return "Hosts Manager";
            if (value == "VC\u8fd0\u884c\u5e93\u5408\u96c6") return "VC Runtime Pack";
            if (value == "Win\u4f20\u7edf\u53f3\u952e") return "Classic Windows Context Menu";
            if (value == "\u5c11\u5e74\u97f3\u9891\u8d44\u6e90\u7f51") return "Teen Audio Resources";
            if (value == "\u5de5\u5177\u7bb1\u540e\u53f0\u767b\u5f55") return "Toolbox Admin Login";
            if (value == "\u673a\u67b6\u4e0e\u865a\u62df\u58f0\u5361") return "Rack Hosts and Virtual Audio";
            if (value == "\u97f5\u5473\u7cfb\u7edf\u5de5\u5177\u7bb1") return "Yunwei System Toolbox";
            if (value == "7-Zip\u89e3\u538b\u7f29") return "7-Zip Extractor";
            if (value == "ToDesk\u8fdc\u63a7") return "ToDesk Remote Control";
            if (value == "ToDesk\u8fdc\u7a0b") return "ToDesk Remote Control";
            if (value == "UU\u8fdc\u7a0b\u7cbe\u7b80\u8fdc\u63a7") return "UU Remote Control";
            if (value == "\u7f16\u8f91 Hosts") return "Edit Hosts";
            if (value == "\u8fd9\u91cc\u8fd8\u6ca1\u6709\u6309\u94ae\u3002") return "No items yet.";
            if (value == "\u603b\u7ba1\u7406\u5458\u9ed8\u8ba4\u8d26\u53f7\uff1aadmin\uff0c\u9ed8\u8ba4\u5bc6\u7801\uff1adev-token\u3002") return "Default super admin: admin, default password: dev-token.";
            return "";
        }
